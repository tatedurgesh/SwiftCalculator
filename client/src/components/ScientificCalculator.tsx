...
export function ScientificCalculator({ onCalculate }: ScientificCalculatorProps) {
  ...
  return (
    <div className="grid grid-cols-7 gap-1 text-sm">
      {/* Row 1 */}
      <button className="calculator-button bg-gray-300 dark:bg-gray-600 text-black dark:text-white rounded-full aspect-square text-[9px] font-medium shadow-sm min-h-[35px] max-h-[50px]">
        2nd
      </button>
      <button className="calculator-button bg-gray-300 dark:bg-gray-600 text-black dark:text-white rounded-full aspect-square text-[9px] font-medium shadow-sm min-h-[35px] max-h-[50px]">
        Rad
      ...
      <button 
        className="calculator-button bg-gray-300 dark:bg-gray-600 text-black dark:text-white rounded-full aspect-square text-[9px] font-medium shadow-sm min-h-[35px] max-h-[50px]"
      ...
      <button 
        className="calculator-button ios-orange text-white rounded-full aspect-square text-[9px] font-medium shadow-sm min-h-[35px] max-h-[50px]"
      ...
      <button 
        className="calculator-button bg-white dark:bg-gray-800 text-black dark:text-white rounded-full aspect-square text-[9px] font-medium shadow-sm min-h-[35px] max-h-[50px]"
      ...
      <button 
        className="calculator-button ios-pink text-white rounded-full aspect-square text-[9px] font-medium shadow-sm min-h-[35px] max-h-[50px]"
