...
export function ScientificCalculator({ onCalculate }: ScientificCalculatorProps) {
  ...
  return (
    <div className="grid grid-cols-7 gap-1 text-sm max-w-lg mx-auto">
      {/* Row 1 */}
      <button className="calculator-button bg-gray-300 dark:bg-gray-600 text-black dark:text-white rounded-full w-full h-12 text-[9px] font-medium shadow-sm">
        2nd
      </button>
      <button className="calculator-button bg-gray-300 dark:bg-gray-600 text-black dark:text-white rounded-full w-full h-12 text-[9px] font-medium shadow-sm">
        Rad
