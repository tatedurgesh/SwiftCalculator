...
export function BasicCalculator({ onCalculate }: BasicCalculatorProps) {
  ...
  return (
    <div className="grid grid-cols-4 gap-4">
      {/* Row 1 */}
      <button 
        className="calculator-button bg-gray-300 dark:bg-gray-600 text-black dark:text-white rounded-full h-16 w-16 text-xl font-medium shadow-sm"
      ...
      <button 
        className="calculator-button ios-orange text-white rounded-full h-16 w-16 text-xl font-medium shadow-sm"
      ...
      {/* Row 2 */}
      <button 
        className="calculator-button bg-white dark:bg-gray-800 text-black dark:text-white rounded-full h-16 w-16 text-xl font-medium shadow-sm"
      ...
      <button 
        className="calculator-button ios-pink text-white rounded-full h-16 w-16 text-xl font-medium shadow-sm"
